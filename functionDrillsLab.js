...
const jsNinja = () => "I am a coding ninja";
...
const greaterNum = compareNums(554, 89);
...
let newnameCheck = nameCheck("McLovin");
...
function printAllNames(names){
  ...
  return names;  
  // ?why cant i return name[i]?
}
const printarr = printAllNames(namesArr);
...
function thatsOdd(number){
 ...
 const oddChecker = thatsOdd(46426439498);
...
////////////////// PROBLEM 15 ////////////////////
const bigOrSmallArray = [1,101, 102, 2, 103, 4, 5, 6, 107]
/* 
...
function theEliminator(contestants, loser){
  ...
  return contestants
  // IM having trouble on where i should put the return  placemnt   and  what would happen if i returned contestants outside the function or befor the if statement
}
...
const capsLock = problem17(sampleString);
